...
const OrderAddress = ({ setAddress }: { setAddress: Address }) => {
  ...
  return (
    <div className=" w-[700px] rounded-2xl border shadow-lg p-4">
      ...
      <Button onClick={() => setAddress(address)}>Хаяг баталгаажуулах</Button>
    </div>
  );
};
