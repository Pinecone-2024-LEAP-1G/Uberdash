...
export const Singup = () => {
    return (
        <div className="w-[332px] h-[536px]  justify-center flex p-2 ">
            <div className="p-7" >
                ...
                <div className="py-8">
                    <div className="py-4">
                        <Input className="w-full h-[48px] bg-slate-200   " type="email" placeholder="Enter phone number or email" />
                    </div>

                    <button className="w-full h-[48px] bg-black flex justify-center text-center py-3 text-white rounded-xl ">Continue</button>
                </div>
